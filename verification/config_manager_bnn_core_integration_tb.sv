...
module config_manager_bnn_core_integration_tb;
    ...
    initial begin
        ...
        // ------------------------------------------------------------
        // TEST 1: Layer 0 weight payload reaches core layer 1 config bus
        // ------------------------------------------------------------
        begin
            logic [7:0] payload[];
            cfg_txn_t   exp[];
        ...
        // ------------------------------------------------------------
        // TEST 2: Layer 1 threshold payload reaches core layer 2 config bus
        // ------------------------------------------------------------
        begin
            logic [7:0]  payload[];
        ...
        // ------------------------------------------------------------
        // TEST 3: Layer 2 weight payload reaches core layer 3 config bus
        // ------------------------------------------------------------
        begin
            logic [7:0] payload[];
            cfg_txn_t   exp[];
        ...
        // ------------------------------------------------------------
        // TEST 4: Unknown layer id should not reach any core layer bus
        // ------------------------------------------------------------
        begin
            logic [7:0] payload[];
            int base;
